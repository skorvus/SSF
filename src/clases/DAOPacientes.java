...
public class DAOPacientes extends Pacientes {
    ...
    public DAOPacientes(int idPaciente, String nombre, String apPat, String apMat, int noExpediente, char actaIfe, char estado, String estadoCivil, String fechaNac, String procedencia, char seguro, String origen, String tpPaciente, String tpSangre, String Alergias, String fechaIngreso, String areas, String diagnostico, String tel) {
        super(idPaciente, nombre, apPat, apMat, noExpediente, actaIfe, estado, estadoCivil, fechaNac, procedencia, seguro, origen, tpPaciente, tpSangre, Alergias, fechaIngreso, areas, diagnostico, tel);
    }
    ...
    public  boolean agregar(){
       ...
       try {
           ...
           pstm.setString(7, super.getProcedencia());
           pstm.setString(8, super.getOrigen());
           pstm.setString(9, ""+super.getSeguro());
           pstm.setString(10, super.getTel());
           pstm.setString(11, super.getTpPaciente());
           pstm.setString(12, super.getAreas());
           pstm.setString(13, super.getTpSangre());
           pstm.setString(14, super.getDiagnostico());
           pstm.setString(15, super.getAlergias());
           pstm.setString(16,""+super. getActaIfe());
    ...
    public boolean modificar() {
        ...
        try {
           ...
           pstm.setString(14, super.getDiagnostico());
           pstm.setString(15, super.getAlergias());
           pstm.setInt(16, super.getIdPaciente());
           pstm.setString(17,""+super. getActaIfe());
            pstm.execute();
    ...
    public boolean buscar() {
        ...
        try {
            ...
            if (rs.next()) {  
                ...
                super.setProcedencia(rs.getString( "procedencia"));
                super.setSeguro(rs.getString("seguro").charAt(0));
                super.setOrigen(rs.getString("origen"));
...
//<editor-fold defaultstate="collapsed" desc="FiltrarPacientes">
    ...
    public void setPaciente(Pacientes pac){
        ...
        super.setProcedencia(pac.getProcedencia());
        super.setSeguro(pac.getSeguro());
        super.setOrigen(pac.getOrigen());
