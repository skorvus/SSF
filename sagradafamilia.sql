...
--
-- Servidor: localhost
-- Tiempo de generación: 02-03-2018 a las 00:18:11
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `Activar_Paciente` (`my_NoExpediente` INT)  BEGIN
	UPDATE Pacientes SET estado = '1' WHERE NoExpediente = my_NoExpediente;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `buscar_Responsable` (`my_IdResponsable` INT)  BEGIN
	SELECT * FROM Responsables WHERE activo = '1' AND IdResponsable = my_IdResponsable;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `delete_Paciente` (`my_id` INT)  BEGIN
	UPDATE Pacientes SET activo='0' WHERE idPaciente = my_id;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `del_detalle` (`my_IdPaciente` INT, `my_IdResponsable` INT)  BEGIN
	UPDATE DetallesPacientes SET activo = '0' WHERE IDPaciente = my_IdPaciente AND IdResponsable = my_IdResponsable;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `del_Responsable` (`my_IdResponsable` INT)  BEGIN
	UPDATE Responsables SET activo = '0' WHERE IdResponsable = my_IdResponsable;

END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `Desactivar_Paciente` (`my_NoExpediente` INT)  BEGIN
	UPDATE Pacientes SET estado = '0' WHERE NoExpediente = my_NoExpediente;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `filtrar_Pacientes` (`filtro` VARCHAR(255))  BEGIN
	SELECT IDPaciente,CONCAT(Nombre,' ',ApPat, ' ',ApMat) AS Nombre_Completo from Pacientes where activo = '1' AND Nombre LIKE concat(filtro,'%'); 
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `filtrar_Responsables` (`filtro` VARCHAR(255))  BEGIN
	SELECT IdResponsable,CONCAT(NombreResponsable,' ',ApPatResponsable, ' ',ApMatResponsable) AS Nombre_Completo
	from Responsables where activo = '1' AND NombreResponsable LIKE concat(filtro,'%'); 
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `insuser` (`clave` VARCHAR(30), `pwd` VARCHAR(50), `nom` VARCHAR(30), `ap` VARCHAR(30), `am` VARCHAR(30), `mpac` INT, `mfarm` INT, `mctlenf` INT, `mbene` INT, `minv` INT, `mpersmed` INT)  begin
  insert into usuarios(clave,password,nombre,appat,apmat,mpacientes,mfarmacia,mbenefactores,mctrlenf,minventario,mpersmed) 
values(clave,pwd,nom,ap,am,mpac,mfarm,mctlenf,mbene, minv,mpersmed);
end$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `ins_Detalle` (`my_IdPaciente` INT, `my_IdResponsable` INT)  BEGIN
	IF EXISTS (SELECT IdDetalle FROM DetallesPacientes WHERE activo = '0')
	THEN 
		UPDATE DetallesPacientes SET activo = '1';
	ELSEIF NOT EXISTS(SELECT IdDetalle FROM DetallesPacientes WHERE activo = '1') 
	THEN
		INSERT INTO DetallesPacientes (IdPaciente, IdResponsable) VALUES (my_IdPaciente, my_IdResponsable);
	
	END IF;
	
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `ins_Movimiento` (`my_NoExpediente` INT, `my_Descripcion` VARCHAR(30), `my_Autorizado` VARCHAR(255), `my_Motivos` VARCHAR(255), `my_Comentarios` VARCHAR(255))  BEGIN
	DECLARE my_IdPaciente int;
	SET my_IdPaciente = (SELECT IdPaciente FROM Pacientes where NoExpediente = my_NoExpediente);
	INSERT INTO RegistroMovimientos (IdPaciente, NoExpediente, Descripcion, Autorizado, Motivos, Comentarios) 
	VALUES (my_IdPaciente, my_NoExpediente,my_Descripcion,my_Autorizado,my_Motivos ,my_Comentarios);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `ins_Paciente` (`my_Nombre` VARCHAR(50), `my_ApPat` VARCHAR(50), `my_ApMat` VARCHAR(50), `my_NoExpediente` INT, `my_EstadoCivil` VARCHAR(20), `my_FechaNac` DATETIME, `my_Procedencia` VARCHAR(60), `my_Origen` VARCHAR(60), `my_Seguro` CHAR(1), `my_Telefono` VARCHAR(10), `my_TpPaciente` VARCHAR(50), `my_Area` VARCHAR(25), `my_TpSangre` VARCHAR(10), `my_Diagnostico` VARCHAR(255), `my_Alergias` VARCHAR(255), `my_ActaIfe` CHAR(1))  BEGIN
	INSERT INTO Pacientes(   Nombre,   ApPat,   ApMat,   NoExpediente,   EstadoCivil,   Seguro,   FechaNac,   Procedencia,  Origen,
                      	   Telefono,   TpPaciente,   Area,   TpSangre,   Diagnostico,   Alergias,   
						   ActaIfe)
						 
               	   VALUES(my_Nombre,my_ApPat,my_ApMat,my_NoExpediente,my_EstadoCivil,my_Seguro,my_FechaNac,my_Procedencia,my_Origen,
                      	my_Telefono,my_TpPaciente,my_Area,my_TpSangre,my_Diagnostico,my_Alergias,
						my_ActaIfe);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `ins_Responsable` (`my_IdPaciente` INT, `my_NombreResponsable` VARCHAR(40), `my_ApPatResponsable` VARCHAR(30), `my_ApMatResponsable` VARCHAR(30), `my_Tel` VARCHAR(15), `my_Tel2` VARCHAR(15), `my_Tel3` VARCHAR(15), `my_Relacion` VARCHAR(35), `my_NoExt` VARCHAR(20), `my_NoInt` VARCHAR(20), `my_Colonia` VARCHAR(255), `my_Estado` VARCHAR(255), `my_Municipio` VARCHAR(255), `my_Calle` VARCHAR(255), `my_CP` VARCHAR(5))  BEGIN
	INSERT INTO Responsables(NombreResponsable,ApPatResponsable,
	ApMatResponsable,Tel,Tel2,Tel3,Relacion,NoExt,NoInt,Colonia,Estado,Municipio,Calle,CP) 
	VALUES(
	my_NombreResponsable,my_ApPatResponsable,my_ApMatResponsable,my_Tel,my_Tel2,my_Tel3,
	my_Relacion,my_NoExt,my_NoInt,my_Colonia,my_Estado,my_Municipio,my_Calle,my_CP);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `listar_Egresos` (`my_NoExpediente` INT)  BEGIN
	SELECT rm.Fecha, CONCAT(p.Nombre,' ',p.ApPat,' ',p.ApMat) AS Nombre,rm.comentarios,rm.Motivos FROM RegistroMovimientos rm 
	INNER JOIN Pacientes p on p.IdPaciente = rm.IdPaciente
	WHERE rm.NoExpediente = my_NoExpediente and rm.descripcion = 'Egresar';
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `listar_Movimientos` (`my_NoExpediente` INT)  BEGIN
	SELECT rm.Fecha,rm.Autorizado,rm.Comentarios,rm.Descripcion, CONCAT(p.Nombre,' ',p.ApPat,' ',p.ApMat) AS Nombre FROM RegistroMovimientos rm 
	INNER JOIN Pacientes p on p.IdPaciente = rm.IdPaciente
	WHERE rm.NoExpediente = my_NoExpediente;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `listar_Reingresos` (`NoExpediente` INT)  BEGIN
	SELECT rm.Fecha,CONCAT(p.Nombre,' ',p.ApPat,' ',p.ApMat) AS Nombre,rm.comentarios FROM RegistroMovimientos rm 
	INNER JOIN Pacientes p on p.IdPaciente = rm.IdPaciente
	WHERE rm.NoExpediente = NoExpediente and rm.descripcion = 'Reingresar';
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `listar_Responsable` ()  BEGIN
	SELECT r.IdResponsable AS 'Id',CONCAT(r.NombreResponsable,' ',r.ApPatResponsable, ' ',r.ApMatResponsable) AS 'Nombre Responsable',
	r.Tel,r.Tel2,r.Tel3 FROM Responsables r 

	where r.activo = '1';
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `lista_PorPaciente` (`my_IdPaciente` INT)  BEGIN
	SELECT CONCAT(r.NombreResponsable,' ',r.ApPatResponsable,' ',r.ApMatResponsable) AS Nombre, r.Tel AS Telefono
	 FROM DetallesPacientes  drp 
	INNER JOIN Responsables r  on r.IdResponsable = drp.IdResponsable
	WHERE  drp.IDPaciente = my_IdPaciente AND drp.activo = '1';
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `lista_PorResponsable` (`my_IdResponsable` INT)  BEGIN
	SELECT  CONCAT(p.Nombre,' ',p.ApPat,' ',p.ApMat) AS Nombre, ((TIMESTAMPDIFF(YEAR, fechaNac, CURDATE()))) AS Edad, p.Estado, p.Diagnostico
	FROM DetallesPacientes dpr 
	INNER JOIN Pacientes p on p.IDPaciente = dpr.IdResponsable
	WHERE IdResponsable = my_IdResponsable AND dpr.activo = '1';
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `list_Completo` ()  BEGIN
...
CREATE TABLE `benefactores` (
  ...
  `CP` char(5) COLLATE utf8_spanish_ci DEFAULT NULL,
  `FechaNacimiento` date DEFAULT NULL,
  `Tipo` varchar(6) COLLATE utf8_spanish_ci DEFAULT NULL,
...
CREATE TABLE `detalleasignacion` (
  `idDetAsignacion` int(11) NOT NULL,
  `idAsignacion` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `detallesdonacion`
--

CREATE TABLE `detallesdonacion` (
  `IdDonacion` int(11) NOT NULL,
  `Descripción` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `Cantidad` int(11) NOT NULL,
  `CostoAprox` float DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `detallespacientes`
--
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Tabla de Estados de la Rep�blica Mexicana';
...
--
-- Estructura de tabla para la tabla `medioadministracion`
--
...
(151, 7, '071', 'Villa Comaltitl'),
(152, 7, '072', 'Pueblo Nuevo Solistahuac'),
(153, 7, '073', 'Ray'),
(154, 7, '074', 'Reforma                            '),
(155, 7, '075', 'Las Rosas                          '),
(156, 7, '076', 'Sabanilla                          '),
...
(503, 13, '056', 'Santiago Tulantepec                '),
...
CREATE TABLE `owner` (
  ...
  `Nombre` varchar(40) COLLATE utf8_spanish_ci NOT NULL,
  `Calle` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `Num_Int` varchar(6) COLLATE utf8_spanish_ci NOT NULL,
  `Num_Ext` varchar(6) COLLATE utf8_spanish_ci NOT NULL,
  `Colonia` varchar(6) COLLATE utf8_spanish_ci NOT NULL,
  `IdMunicipio` int(11) NOT NULL,
...
CREATE TABLE `pacientes` (
  ...
  `ApMat` varchar(30) COLLATE utf8_spanish_ci DEFAULT NULL,
  `NoExpediente` int(11) NOT NULL,
  `EstadoCivil` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `FechaNac` date NOT NULL,
  `Procedencia` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
  `Seguro` char(1) COLLATE utf8_spanish_ci DEFAULT NULL,
  `Origen` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
  `Telefono` varchar(10) COLLATE utf8_spanish_ci DEFAULT NULL,
  `TpPaciente` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `Area` varchar(25) COLLATE utf8_spanish_ci NOT NULL,
  `TpSangre` varchar(10) COLLATE utf8_spanish_ci NOT NULL,
  ...
  `activo` char(1) COLLATE utf8_spanish_ci DEFAULT '1',
  `ActaIfe` char(1) COLLATE utf8_spanish_ci DEFAULT NULL,
...
INSERT INTO `pacientes` (`IDPaciente`, `Nombre`, `ApPat`, `ApMat`, `NoExpediente`, `EstadoCivil`, `FechaNac`, `Procedencia`, `Seguro`, `Origen`, `Telefono`, `TpPaciente`, `Area`, `TpSangre`, `Diagnostico`, `Alergias`, `estado`, `activo`, `ActaIfe`, `FechaIngreso`) VALUES
(1, 'HORACIO', 'LOPEZ', 'GARCIA', 120, 'VIUDA', '1978-12-12', 'Colima,Comala                             ', '1', 'Baja California,Mexicali                           ', '6666555', 'PSQUIATRÍA', 'Nazaret', 'B+', 'ESQUIZOFRENIA TEMPRANA', 'PENICILINA Y CACAHUATE', '1', '1', '0', NULL);
...
--
-- Estructura de tabla para la tabla `registromovimientos`
--
...
CREATE TABLE `registromovimientos` (
  ...
  `Autorizado` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `Motivos` varchar(30) COLLATE utf8_spanish_ci DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Registro actividad del istema';
...
CREATE TABLE `responsables` (
  ...
  `NombreResponsable` varchar(40) COLLATE utf8_spanish_ci DEFAULT NULL,
  `ApPatResponsable` varchar(30) COLLATE utf8_spanish_ci DEFAULT NULL,
  `ApMatResponsable` varchar(30) COLLATE utf8_spanish_ci DEFAULT NULL,
  `Tel` varchar(15) COLLATE utf8_spanish_ci DEFAULT NULL,
  `Tel2` varchar(15) COLLATE utf8_spanish_ci DEFAULT NULL,
  `Tel3` varchar(15) COLLATE utf8_spanish_ci DEFAULT NULL,
  `Relacion` varchar(35) COLLATE utf8_spanish_ci DEFAULT NULL,
  `NoExt` varchar(20) COLLATE utf8_spanish_ci DEFAULT NULL,
  `NoInt` varchar(20) COLLATE utf8_spanish_ci DEFAULT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `mpacientes` tinyint(4) NOT NULL,
  `mfarmacia` tinyint(4) NOT NULL,
  `mbenefactores` tinyint(4) NOT NULL,
  `mctrlenf` tinyint(4) NOT NULL,
  `minventario` tinyint(4) NOT NULL,
  `mpersmed` tinyint(4) NOT NULL,
  `musuarios` tinyint(4) NOT NULL
...
INSERT INTO `usuarios` (`idusuario`, `clave`, `password`, `nombre`, `appat`, `apmat`, `mpacientes`, `mfarmacia`, `mbenefactores`, `mctrlenf`, `minventario`, `mpersmed`, `musuarios`) VALUES
(1, 'sorvero', 'c89604969f1502b8640aa858fd045195874bad97', 'VERONICA', 'LOPEZ', 'HERNANDEZ', 1, 1, 1, 1, 1, 1, 1),
(2, 'jflores', '8c59aeff70312605bcf95fa28b0b19531ee6decc', 'Joel', 'Flores', 'Cervantes', 1, 1, 1, 1, 0, 0, 1),
(3, 'rgalvan', '3d47dfe4de99df03156fc4efe1876a1eb665f2e5', 'Ramiro', 'Galvan', 'Lopez', 0, 1, 0, 0, 1, 0, 0),
(4, 'paola', '727207cf4a41bd8827d0cd21c5fb52eaac56d918', 'paola', 'lopez', 'perez', 0, 1, 0, 0, 0, 0, 0),
(5, 'invitado', '7fb6a171fef8cf047629ffb203cb588d836a3818', 'anonimo', 'fulanmo', 'de tal', 0, 0, 0, 0, 0, 0, 0),
(6, 'mrodriguez', '350dc771f8b8f12f703986c9c19c7eca6beaf146', 'martin', 'rodriguez', 'robles', 0, 1, 0, 0, 0, 0, 0),
(7, 'joelfc', '018bd691fa37ec0f05fc4037cb9576cefeb307d2', 'joel', 'ramirez', 'Lopez', 0, 0, 1, 0, 0, 1, 0),
(8, 'flavio', '5aed2c80a7884032f87d9136b98d5a4ba3dbd8c6', 'Flavio', 'Romero', 'Velazco', 0, 0, 1, 0, 0, 1, 0);
...
--
-- Indices de la tabla `detallesdonacion`
--
ALTER TABLE `detallesdonacion`
  ADD KEY `IdDonacion` (`IdDonacion`);

--
-- Indices de la tabla `detallespacientes`
--
ALTER TABLE `detallespacientes`
...
--
-- Indices de la tabla `medioadministracion`
--
ALTER TABLE `medioadministracion`
...
ALTER TABLE `pacientes`
  ...
  ADD UNIQUE KEY `NoExpediente` (`NoExpediente`);
...
--
-- Indices de la tabla `registromovimientos`
--
ALTER TABLE `registromovimientos`
...
--
ALTER TABLE `benefactores`
  MODIFY `IdBenefactor` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `detalleasignacion`
  MODIFY `idDetAsignacion` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT de la tabla `detallespacientes`
--
ALTER TABLE `detallespacientes`
...
--
-- AUTO_INCREMENT de la tabla `medioadministracion`
--
ALTER TABLE `medioadministracion`
...
--
-- AUTO_INCREMENT de la tabla `registromovimientos`
--
ALTER TABLE `registromovimientos`
...
--
ALTER TABLE `contactos`
  ADD CONSTRAINT `contactos_ibfk_1` FOREIGN KEY (`IdBenefactor`) REFERENCES `benefactores` (`IdBenefactor`);

--
-- Filtros para la tabla `detallesdonacion`
--
ALTER TABLE `detallesdonacion`
  ADD CONSTRAINT `detallesdonacion_ibfk_1` FOREIGN KEY (`IdDonacion`) REFERENCES `donaciones` (`IdDonacion`);

--
-- Filtros para la tabla `detallespacientes`
--
ALTER TABLE `detallespacientes`
  ADD CONSTRAINT `detallespacientes_ibfk_1` FOREIGN KEY (`IDPaciente`) REFERENCES `pacientes` (`IDPaciente`),
  ADD CONSTRAINT `detallespacientes_ibfk_2` FOREIGN KEY (`IdResponsable`) REFERENCES `responsables` (`IdResponsable`);

--
-- Filtros para la tabla `donaciones`
--
ALTER TABLE `donaciones`
  ADD CONSTRAINT `donaciones_ibfk_1` FOREIGN KEY (`IdBenefactor`) REFERENCES `benefactores` (`IdBenefactor`);

--
-- Filtros para la tabla `registromovimientos`
--
ALTER TABLE `registromovimientos`
  ADD CONSTRAINT `registromovimientos_ibfk_1` FOREIGN KEY (`IdPaciente`) REFERENCES `pacientes` (`IDPaciente`);
